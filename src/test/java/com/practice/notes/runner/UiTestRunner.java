...
public class UiTestRunner extends AbstractTestNGCucumberTests {
    ...
    /**
     * Overrides runScenario to wire SmartRetryAnalyzer.
     * Cucumber 7 requires the exact (PickleWrapper, FeatureWrapper) signature.
     * retryAnalyzer activates decision-based rerun for transient Selenium failures.
     */
